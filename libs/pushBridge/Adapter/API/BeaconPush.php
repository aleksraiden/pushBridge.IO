...
class BeaconPush {
     ...
     * Send the request
     */
    protected static function _request($method, $command, $arg=NULL, $data=array(), $curl_timeout=30)
    {
    ...
    public static function send_to_channel($channel, $event, $data = array())
    {
        return BeaconPush::_request('POST', 'channels', $channel, array('name' => $event, 'data' => $data));
    }

    public static function send_to_channels(array $channels, $event, $data = array())
    {
        $r = array();
